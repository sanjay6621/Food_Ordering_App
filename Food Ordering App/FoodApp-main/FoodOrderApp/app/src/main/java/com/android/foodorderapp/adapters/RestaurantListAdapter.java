...
// creating the recycler view adapter to create viewholder objects .
...
public class RestaurantListAdapter extends RecyclerView.Adapter<RestaurantListAdapter.MyViewHolder> {
    ...
    @NonNull
    @Override
    // calling oncreate method to create new viewholder .
    ...
    @Override
    // this method finds the data assosciated to recyclers view and displays in the text widget .
    ...
    @Override
    // calling this method to get the size of the data .
